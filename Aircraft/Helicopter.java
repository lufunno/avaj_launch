...
public class Helicopter extends Aircraft implements Flyable{
    ...
    public void updateConditions(){
        ...
        if ( weather.equals("SUN" ) ){
            ...
            WriteFile.writeToFile( "Helicopter#" + this.name + "(" + this.id + ") I feel blacker than Mugabe!" );
        }
        else if ( weather.equals("RAIN" ) ){
            this.coordinates.setHeight( this.coordinates.getHeight() - 5 );
            WriteFile.writeToFile( "Helicopter#" + this.name + "(" + this.id + ") Driizzzllleesss for Cape Town." );
        }
        else if ( weather.equals("FOG" ) ){
            this.coordinates.setHeight( this.coordinates.getHeight() - 1 );
            WriteFile.writeToFile( "Helicopter#" + this.name + "(" + this.id + ") Whoooaaaa fogging hell!?" );
        }
        else if ( weather.equals("SNOW" ) ){
            coordinates.setHeight( this.coordinates.getHeight() - 12 );
            WriteFile.writeToFile( "Helicopter#" + this.name + "(" + this.id + ") F-f-f-frreezzziiinnng!" );
        }
